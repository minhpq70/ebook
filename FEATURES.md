...
| **Nguồn dữ liệu** | Top 5-8 đoạn sách liên quan nhất |
| **Temperature** | 0.2 (câu hỏi thường), 0.0 (hỏi mục lục) |
| **Đặc biệt** | Tự động nhận diện câu hỏi về mục lục → tăng chunks lên 20, output lên 12K tokens |
| **Chống sai lệch** | Sao chép nguyên văn tên riêng, thuật ngữ từ sách, không diễn giải lại |
...
| Tính năng | Mô tả |
|-----------|-------|
| **Upload sách PDF** | Upload file PDF (≤ 50MB), tự động trích xuất metadata bằng AI |
